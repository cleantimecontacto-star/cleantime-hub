...
> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="flex items-center justify-center min-h-[300px] p-4 bg-red-50 rounded-lg border border-red-200 my-4">
          <div className="bg-white p-6 rounded-lg shadow-sm max-w-2xl w-full border border-red-100">
            ...
            <p className="text-gray-600 mb-4 text-sm">
              Se ha detectado un error inesperado. Los detalles técnicos se muestran a continuación para facilitar su reparación.
            </p>
